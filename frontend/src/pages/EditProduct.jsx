...
import { Edit3, Image, Loader, AlertCircle, ArrowLeft } from 'lucide-react';
...
const EditProduct = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8 min-h-[85vh]">
      <Link to={`/product/${id}`} className="inline-flex items-center gap-1.5 text-sm text-gray-600 hover:text-indigo-600 mb-6 font-medium transition-colors">
        <ArrowLeft size={16} />
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-6 md:p-8 shadow-sm">
        <div className="flex items-center gap-2 mb-6">
          ...
          <h1 className="text-2xl font-extrabold text-gray-900 tracking-tight">Edit Product Listing</h1>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1.5">
              Product Image (Leave blank to keep existing image)
            </label>
